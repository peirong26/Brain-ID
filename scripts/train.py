...
def train(args: Namespace) -> None:
    ...
    # ============ building model ... ============
    args, model, processors, criterion, postprocessor = build_feat_model(args, device = device) # train: True; test: False
    ...
    if args.resume or args.eval_only:
        ...
        args.start_epoch, best_val_stats = load_checkpoint(ckp_path, [model_without_ddp], optimizer, ['model'], exclude_key = 'supervised_seg') 
    ...
    for epoch in range(args.start_epoch, args.n_epochs):
        ...
        log_stats = train_one_epoch_feature(epoch, args, model_without_ddp, processors, criterion, data_loader_train,
                                    optimizer, lr_scheduler, wd_scheduler, postprocessor, visualizers, vis_train_dir, device) 
